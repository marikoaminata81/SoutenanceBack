...
public class Notification {
    ...
    public boolean equals(Object o) {
        ...
        return id.equals(that.id) && type.equals(that.type) && receiver.equals(that.receiver) && owningVideo.equals(that.owningVideo);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, type, receiver, owningVideo);
    }
}
