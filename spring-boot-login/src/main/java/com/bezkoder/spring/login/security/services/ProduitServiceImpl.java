...
public class ProduitServiceImpl implements ProduitService {
    ...
    @Override
    public List<Produit> ListeDesProduitValider(Produit produit) {
    ...
    public Produit createNewProduit(String nom , MultipartFile imagecouverture,Double prix, String reference ,String description, Categorie categorie) throws IOException {
